 ...
 */
  ...
  //#define ADAPTIVE_FAN_SLOWING              //E3SKR13 - To be tested - Slow part cooling fan if temperature drops
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        10 //E3SKR13 - Changed from 20 to 10 - Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                10 //E3SKR13 - Changed from 60 to 10 - Seconds
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //E3SKR13 - Changed from -1 - Defined in pins.h, = -1
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define BOOTSCREEN_TIMEOUT 2000        //E3SKR13 (ms) Total Duration to display the boot screen(s)
#endif
 ...
 */
#define BABYSTEPPING //E3SKR13 - EZABL - Unchanged
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    //E3SKR13 - EZABL - Unchanged - Double-click on the Status Screen for Z Babystepping.
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 2000   //E3SKR13 - EZABL - Changed from 1250 to 2000 - Maximum interval between clicks, in milliseconds. Note: Extra time may be added to mitigate controller latency.
 ...
 */
//#define LIN_ADVANCE //E3SKR13 - Enable later
 ...
 */
#define ADVANCED_PAUSE_FEATURE //E3SKR13
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      900 //E3SKR13 - For stock stepper
    #define E0_MICROSTEPS    16
  ...
  //#define STEALTHCHOP_E //E3SKR13 - To avoid loosing steps
   ...
   */
  #define MONITOR_DRIVER_STATUS //E3SKR13
   ...
   */
  #define HYBRID_THRESHOLD //E3SKR13
